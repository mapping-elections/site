...
cities <- tribble(
  ~city, ~lat, ~lng, ~federalist_percentage, ~demrep_percentage, ~federalist_vote, ~demrep_vote,
    "Philadelphia", 39.9526, -75.1652, 0.682, 0.318, 496, 231)
```
...
Pennsylvania elected eight Federalists and seventeen Democratic-Republicans to the Eighteenth Congress. 

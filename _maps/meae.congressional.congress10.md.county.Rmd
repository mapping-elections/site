...
cities <- tribble(
  ~city, ~lat, ~lng, ~federalist_percentage, ~demrep_percentage, ~dissrep_percentage, ~federalist_vote, ~demrep_vote, ~dissrep_vote,
  "Baltimore", 39.30021, -76.61052, 0.039, 0.78, 0.181, 245, 4935, 1143
)
```
...
map_id %>%
  ...
  addCircleMarkers(data = cities, lat = ~lat, lng = ~lng, color = "black",
                   ...
                   popup = ~paste0("<b>City of ", city, "</b><br/>",
                                   ...
                                   " votes)<br/>",
                                   "Dissenting Republicans: ", dissrep_percentage * 100,
                                   "% (", 
                                   prettyNum(dissrep_vote, big.mark = ","),
                                   " votes)"),
                   label = ~city)
```

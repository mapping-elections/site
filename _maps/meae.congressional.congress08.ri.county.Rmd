...
geography: county
congressnum: 8
title: Elections for the Eighth Congress in Rhode Island, 1802
...
- id: meae.congressional.congress07.ri.county
  name: RI Seventh Congress
  type: previous
- id: meae.congressional.congress09.ri.county
  name: RI Ninth Congress
  type: next
...
meae_id <- "meae.congressional.congress08.ri.county"
